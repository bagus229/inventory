      ...
      <nav class="bg-slate-800 text-white px-6 py-4">
        <div class="flex justify-between">
          ...
          <div class="space-x-4">
            ...
            <router-link to="/dashboard" @click.prevent="guard('/dashboard')">Dashboard</router-link>
            <router-link to="/kategori" @click.prevent="guard('/kategori')">Kategori</router-link>
            <router-link to="/supplier" @click.prevent="guard('/supplier')">Supplier</router-link>
            <router-link to="/barang" @click.prevent="guard('/barang')">Barang</router-link>
            <router-link to="/histori" @click.prevent="guard('/histori')">Histori</router-link>
